...
The palette balances the professional weight of `#25343F` with the electric kinetic energy of `#FF9B51`. The system is now in `dark` mode, reinforcing the high-contrast typography and sophisticated tonal layering.
