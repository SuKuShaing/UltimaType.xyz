...
bmad-bmm-technical-research — Investigación técnica (opcional, recomendada)
bmad-bmm-product-brief — Brief del producto (opcional)

## Fase 2: Planificación (Requerida)

bmad-bmm-create-prd — Crear el PRD ⚡ REQUERIDO
bmad-bmm-validate-prd — Validar el PRD (opcional)
bmad-bmm-create-ux-design — Diseño UX (opcional, tienes bosquejos que formalizar)

## Fase 3: Solucionamiento (Requerida)

bmad-bmm-create-architecture — Arquitectura técnica ⚡ REQUERIDO
