      ...
      <div className="w-full max-w-sm rounded-2xl bg-surface-base/95 px-8 py-10 text-center backdrop-blur-md">
        ...
        {onWatchLive && (
          <button
            type="button"
            onClick={onWatchLive}
            className="mt-4 rounded-lg bg-surface-raised px-6 py-2.5 text-sm font-medium text-text-main transition-colors hover:bg-surface-base focus:outline-none focus:ring-2 focus:ring-primary/50"
          >
            Ver carrera en vivo
          </button>
        )}
